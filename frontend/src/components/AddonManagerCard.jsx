...
export const AddonManagerCard = () => {
    return (
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-500/20 to-pink-500/20 p-8">
            ...
            <div className="relative z-10">
                ...
                <a href="https://stremio-addon-manager.vercel.app/"
                    target="_blank"
